...
print(f"\nВисновок: тим, що Timsort поєднує в собі переваги сортування злиттям і сортування вставками, він є значно більш ефективним, найшвидшим серед трьох алгоритмів на всіх типах масивів, демонструє майже стабільний час виконання.")